...
auto module_NitroGoogleSignin = NitroGoogleSignin_ModuleProvider(moduleName, params);
if (module_NitroGoogleSignin != nullptr) {
return module_NitroGoogleSignin;
}
